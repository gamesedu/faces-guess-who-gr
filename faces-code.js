...
document.getElementById("txt_show_code").value = txt_show_code;
*/
...
//txt_show_code : document.getElementById("txt_show_code") ,
    ...
    cols: 6,
    level: 1,
    level_time: 5120, // this is the initial amount of time for level 1.
    ...
    respond: function(val) {
        ...
        */
		...
		//this.addText(val); //20160315 jon IF..ELSE teach
    },

    question: function(attr, value) {
        if (this.answer[attr].indexOf('?') !== -1) { return "Don't Know"; }
		this.addText(value); //20160315 jon IF..ELSE teach
